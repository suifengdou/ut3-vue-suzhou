<template>
  <div class="mouldsupplier-container">
              ...
              <el-collapse-item>
                ...
                <div class="block">
                  <el-form ref="filterForm" :model="params" label-width="80px">
                    <el-row :gutter="20">
                      <el-col :span="6"><el-form-item label="创建者" prop="company">
                        <template>
                          <el-select
    ...
    >
      ...
      >
        <el-card class="box-card">
          ...
          <el-row :gutter="20">
            <el-col :span="8"><el-form-item label="手板商" prop="name">
...
<script>
import { getMouldSupplierList, createMouldSupplier, updateMouldSupplier } from '@/api/supplier/mouldsup'
import { getCompanyList } from '@/api/base/company'
import moment from 'moment'
export default {
  name: 'mouldsupplier-container',
  data() {
    return {
      DataList: [],
      tableLoading: false,
  ...
  methods: {
    ...
    fetchData() {
      ...
      getMouldSupplierList(this.params).then(
        res => {
    ...
    handleSubmitAdd() {
      ...
      createMouldSupplier(this.formAdd).then(
        () => {
          this.fetchData()
    ...
    handleSubmitEdit() {
      this.$refs.FormEdit.validate(valid => {
        ...
        console.log(data)
        updateMouldSupplier(id, data).then(
          () => {
