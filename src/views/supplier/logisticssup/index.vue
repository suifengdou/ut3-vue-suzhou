...
<script>
import { getLogisticsSupplierList, createLogisticsSupplier, updateLogisticsSupplier } from '@/api/supplier/logisticssup'
...
export default {
  ...
  methods: {
    ...
    fetchData() {
      ...
      getLogisticsSupplierList(this.params).then(
        res => {
    ...
    handleSubmitAdd() {
      ...
      createLogisticsSupplier(this.formAdd).then(
        () => {
          this.fetchData()
    ...
    handleSubmitEdit() {
      this.$refs.FormEdit.validate(valid => {
        ...
        console.log(data)
        updateLogisticsSupplier(id, data).then(
          () => {
