              ...
              <el-collapse-item>
                ...
                <div class="block">
                  <el-form ref="filterForm" :model="params" label-width="80px">
                    <el-row :gutter="20">
                      <el-col :span="6"><el-form-item label="省份名称" prop="name">
      ...
      >
        <el-card class="box-card">
          ...
          <el-row :gutter="20">
            ...
            <el-col :span="8"><el-form-item label="省份" prop="name">
              <el-input v-model="formAdd.name" placeholder="请输入类型" />
            </el-form-item></el-col>
          </el-row>
          <el-row :gutter="20">
...
import {
  ...
  exportProvince,
  excelImportProvince
} from '@/api/utils/geography/province'
...
export default {
  ...
  methods: {
    ...
    fetchData() {
      ...
      getProvinceList(this.params).then(
        res => {
      ...
      this.$msgbox({
        ...
        beforeClose: (action, instance, done) => {
          if (action === 'confirm') {
            ...
            excelImportProvince(importformData, config).then(
              res => {
                this.$notify({
                  title: '导入结果',
                  message: res.data,
      ...
      this.$msgbox({
        ...
        beforeClose: (action, instance, done) => {
          if (action === 'confirm') {
            instance.confirmButtonLoading = true
            instance.confirmButtonText = '执行中...'
            exportProvince(this.params).then(
              res => {
    ...
    handleSubmitAdd() {
      ...
      createProvince(this.formAdd).then(
        () => {
          this.fetchData()
