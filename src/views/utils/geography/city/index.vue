              ...
              <el-collapse-item>
                ...
                <div class="block">
                  <el-form ref="filterForm" :model="params" label-width="80px">
                    ...
                    <el-row :gutter="20">
                      <el-col :span="6"><el-form-item label="城市" prop="name">
    ...
    >
      ...
      >
        <el-card class="box-card">
          ...
          <el-row :gutter="20">
            <el-col :span="8"><el-form-item label="城市" prop="name">
              <el-input v-model="formAdd.name" placeholder="请输入城市" />
            </el-form-item></el-col>
            <el-col :span="8"><el-form-item label="区号" prop="area_code">
              <el-input v-model="formAdd.area_code" placeholder="请输入区号" />
            </el-form-item></el-col>
          </el-row>
        </el-card>
        <el-card class="box-card">
        ...
        <div class="handleFormEdit">
          ...
          >
            <el-card class="box-card">
              ...
              <el-row :gutter="20">
                <el-col :span="8"><el-form-item label="城市" prop="name">
                  <el-input v-model="formEdit.name" placeholder="请输入城市" />
                </el-form-item></el-col>
                <el-col :span="8"><el-form-item label="区号" prop="area_code">
                  <el-input v-model="formEdit.area_code" placeholder="请输入区号" />
                </el-form-item></el-col>
              </el-row>
            </el-card>
            <el-card class="box-card">
  ...
  methods: {
      ...
      this.$msgbox({
        ...
        beforeClose: (action, instance, done) => {
          if (action === 'confirm') {
            ...
            excelImportCity(importformData, config).then(
              res => {
                this.$notify({
                  title: '导入结果',
                  message: res.data,
    ...
    handleSubmitEdit() {
      this.$refs.FormEdit.validate(valid => {
        ...
        console.log(data)
        let attrStr
        const transFieldStr = ['nationality', 'province']
        for (attrStr in transFieldStr) {
          data[transFieldStr[attrStr]] = data[transFieldStr[attrStr]].id
        }
        updateCity(id, data).then(
          () => {
