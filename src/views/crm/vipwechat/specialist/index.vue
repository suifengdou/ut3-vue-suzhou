      ...
      >
        <el-card class="box-card">
          ...
          <el-row :gutter="20">
            ...
            <el-col :span="8"><el-form-item label="账号名" prop="name">
              <el-input v-model="formAdd.name" placeholder="请输入账号名" />
            </el-form-item></el-col>
          </el-row>
          <el-row :gutter="20">
            <el-col :span="8"><el-form-item label="手机" prop="smartphone">
              <el-input v-model="formAdd.smartphone" placeholder="请输入手机" />
            </el-form-item></el-col>
            <el-col :span="8">
              <el-form-item label="是否默认" prop="is_default">
                <el-switch
                  v-model="formAdd.is_default"
                  active-color="#13ce66"
                  inactive-color="#ff4949"
                />
              </el-form-item>
          ...
          <el-row :gutter="20">
            <el-col :span="16"><el-form-item label="描述" prop="description">
              <el-input type="textarea" :rows="5" v-model="formAdd.description" placeholder="请输入描述" />
            </el-form-item></el-col>
          </el-row>
          <el-row :gutter="20">
          ...
          >
            <el-card class="box-card">
              ...
              <el-row :gutter="20">
                ...
                <el-col :span="8"><el-form-item label="账号名" prop="name">
                  <el-input v-model="formEdit.name" placeholder="请输入账号名" />
                </el-form-item></el-col>
              </el-row>
              <el-row :gutter="20">
                <el-col :span="8"><el-form-item label="手机" prop="smartphone">
                  <el-input v-model="formEdit.smartphone" placeholder="请输入手机" />
                </el-form-item></el-col>
                <el-col :span="8">
                  <el-form-item label="是否默认" prop="is_default">
                    <el-switch
                      v-model="formEdit.is_default"
                      active-color="#13ce66"
                      inactive-color="#ff4949"
                    />
                  </el-form-item>
              ...
              <el-row :gutter="20">
                <el-col :span="16"><el-form-item label="描述" prop="description">
                  <el-input type="textarea" :rows="5" v-model="formEdit.description" placeholder="请输入描述" />
                </el-form-item></el-col>
              </el-row>
              <el-row :gutter="20">
                <el-col :span="16"><el-form-item label="备注" prop="memo">
...
import {
  ...
  updateSpecialist,
  exportSpecialist,
  excelImportSpecialist,
  checkSpecialist,
  rejectSpecialist
} from '@/api/crm/vipwechat/specialist'
...
export default {
  ...
  methods: {
    fetchData() {
      ...
      getSpecialistList(this.params).then(
        res => {
    ...
    handleSubmitAdd() {
      ...
      createSpecialist(this.formAdd).then(
        () => {
          this.$notify({
            title: '创建成功',
            type: 'success',
      ...
      this.$msgbox({
        ...
        beforeClose: (action, instance, done) => {
          if (action === 'confirm') {
            ...
            excelImportSpecialist(importformData, config).then(
              res => {
                this.$notify({
                  title: '导入结果',
                  message: res.data,
      ...
      this.$msgbox({
        ...
        beforeClose: (action, instance, done) => {
          if (action === 'confirm') {
            instance.confirmButtonLoading = true
            instance.confirmButtonText = '执行中...'
            exportSpecialist(this.params).then(
              res => {
    ...
    handleCheck() {
      ...
      if (this.params.allSelectTag === 1) {
        checkSpecialist(this.params).then(
          res => {
      ...
      this.$msgbox({
        ...
        beforeClose: (action, instance, done) => {
          if (action === 'confirm') {
            ...
            instance.confirmButtonText = '执行中...'
            if (this.params.allSelectTag === 1) {
              rejectSpecialist(this.params).then(
                res => {
                  if (res.data.successful !== 0) {
                    this.$notify({
                      title: '取消成功',
