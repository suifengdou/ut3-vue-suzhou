              ...
              <el-tooltip class="item" effect="dark" content="点击展开操作列表，可执行对应操作" placement="top-start">
                <el-dropdown split-button type="primary" placement="bottom-end" trigger="click">
                  ...
                  <el-dropdown-menu slot="dropdown" trigger="click">
                    <el-dropdown-item><el-button type="success" icon="el-icon-check" size="mini" round >预留1</el-button></el-dropdown-item>
                    <el-dropdown-item><el-button type="danger" icon="el-icon-close" size="mini" round >预留2</el-button></el-dropdown-item>
                    <el-dropdown-item><el-button type="danger" icon="el-icon-close" size="mini" round >预留3</el-button></el-dropdown-item>
                  </el-dropdown-menu>
                </el-dropdown>
              </el-tooltip>
...
<script>
import {
  getVIPWechatManageList,
  createVIPWechatManage,
  updateVIPWechatManage,
  exportVIPWechatManage,
  excelImportVIPWechatManage,
  checkVIPWechatManage,
  rejectVIPWechatManage
} from '@/api/crm/vipwechat/manage'
...
export default {
  ...
  methods: {
    fetchData() {
      ...
      getVIPWechatManageList(this.params).then(
        res => {
      ...
      this.$msgbox({
        ...
        beforeClose: (action, instance, done) => {
          if (action === 'confirm') {
            ...
            exportVIPWechatManage(this.params).then(
              res => {
