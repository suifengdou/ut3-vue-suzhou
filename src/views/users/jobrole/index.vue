    ...
    >
      ...
      >
        <el-card class="box-card">
          ...
          <el-row :gutter="20">
            <el-col :span="8"><el-form-item label="职务名称" prop="name">
              <el-input v-model="formAdd.name" placeholder="请输入职务名称" />
            </el-form-item></el-col>
            <el-col :span="8"><el-form-item label="公司类型" prop="level">
              <template>
                <el-select
        ...
        <div class="handleFormEdit">
          ...
          >
            <el-card class="box-card">
              ...
              <el-row :gutter="20">
                <el-col :span="8"><el-form-item label="公司全称" prop="memo">
...
<script>
import { getJobroleList, createJobrole, updateJobrole } from '@/api/auth/jobrole'
...
export default {
  ...
  methods: {
    ...
    fetchData() {
      ...
      getJobroleList(this.params).then(
        res => {
    ...
    handleSubmitAdd() {
      ...
      createJobrole(this.formAdd).then(
        () => {
          this.fetchData()
