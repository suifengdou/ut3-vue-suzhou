<template>
  <div class="dealerparts-create-container">
        ...
        <div class="handleFormEdit">
          ...
          >
            <el-card class="box-card">
              ...
              <el-row :gutter="20">
                <el-col :span="8"><el-form-item label="订单号" prop="order_id">
                  <el-input v-model="formEdit.order_id" placeholder="请输入订单号" />
                </el-form-item></el-col>
                <el-col :span="8"><el-form-item label="客户昵称" prop="nickname">
              ...
              <el-row :gutter="20">
                <el-col :span="8"><el-form-item label="客服" prop="servicer">
                  <el-input v-model="formEdit.servicer" placeholder="请输入客服" />
                </el-form-item></el-col>
                <el-col :span="8"><el-form-item label="单据类型" prop="order_category">
            ...
            <el-card class="box-card">
              ...
              <el-row :gutter="20">
                ...
                <el-col :span="8"><el-form-item label="故障部位" prop="broken_part">
                  <el-input v-model="formEdit.broken_part" placeholder="请输入故障部位" />
                </el-form-item></el-col>
                <el-col :span="8" />
              </el-row>
              <el-row :gutter="20">
                <el-col :span="20"><el-form-item label="故障描述" prop="description">
                  <el-input v-model="formEdit.description" placeholder="请输入故障描述" />
                </el-form-item></el-col>
                <el-col :span="8" />
              </el-row>
            </el-card>
...
<script>
  import {
    ...
    setSpecialWorkOrderCreate,
    resetTagWorkOrderCreate
  } from '@/api/wop/dealerparts/create'
    ...
    data() {
      ...
      return {
        ...
        rules: {
          ...
          information: [
            { required: true, message: '请输入问题信息', trigger: 'blur' }
          ],
        },
        OrderDetailsList: [],
    ...
    methods: {
      ...
      handleSetSpecial() {
        ...
        if (this.params.allSelectTag === 1) {
          setSpecialWorkOrderCreate(this.params).then(
            res => {
      ...
      handleResetTag() {
        this.tableLoading = true
        if (this.params.allSelectTag === 1) {
          resetTagWorkOrderCreate(this.params).then(
            res => {
              if (res.data.successful !== 0) {
                this.$notify({
                  title: '设置成功',
