<template>
  <div class="ori-invoice-submit-container">
              ...
              <el-tooltip class="item" effect="dark" content="点击展开操作列表，可执行对应操作" placement="top-start">
                <el-dropdown split-button type="primary" placement="bottom-end" trigger="click">
                  ...
                  <el-dropdown-menu slot="dropdown" trigger="click">
                    ...
                    <el-dropdown-item><el-button type="success" icon="el-icon-share" size="mini" round @click="handleCheckUnpack">拆单审核</el-button></el-dropdown-item>
    ...
    <el-dialog
      ...
      :close-on-press-escape="false"
    >
      <el-form ref="feedbackForm" label-width="10%" :data="feedbackData">
        <hr>
        <el-form-item label="工单反馈">
          <el-input
            v-model="feedbackData.memorandum"
            type="textarea"
        ...
        <el-row :gutter="30">
          <el-col :span="12" :offset="6">
            <el-form-item>
              <el-button type="primary" @click="submitFeedback">提交修改</el-button>
              <el-button type="error" @click="closeFeedback">取消</el-button>
            </el-form-item>
          </el-col>
        </el-row>
...
<script>
import {
  getOriInvoiceListHandle,
  updateOriInvoiceHandle,
  exportOriInvoiceHandle,
  checkOriInvoiceHandle,
  checkUpackOriInvoiceHandle,
  rejectOriInvoiceHandle
...
export default {
  ...
  methods: {
    fetchData() {
      ...
      getOriInvoiceListHandle(this.params).then(
        res => {
    ...
    handleCheck() {
      ...
      if (this.params.allSelectTag === 1) {
        checkOriInvoiceHandle(this.params).then(
          res => {
    ...
    handleCheckUnpack() {
      this.tableLoading = true
      if (this.params.allSelectTag === 1) {
        checkUpackOriInvoiceHandle(this.params).then(
          res => {
            if (res.data.successful !== 0) {
              this.$notify({
                title: '审核成功',
      ...
      this.$msgbox({
        ...
        beforeClose: (action, instance, done) => {
          if (action === 'confirm') {
            ...
            instance.confirmButtonText = '执行中...'
            if (this.params.allSelectTag === 1) {
              rejectOriInvoiceHandle(this.params).then(
                res => {
                  if (res.data.successful !== 0) {
                    this.$notify({
                      title: '驳回成功',
