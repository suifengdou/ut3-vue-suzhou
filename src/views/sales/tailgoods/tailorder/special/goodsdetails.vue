<!--suppress ALL -->
<template>
  <div class="tailorder-goods-special-container">
              ...
              <el-collapse-item>
                ...
                <div class="block">
                  <el-form ref="filterForm" :model="params" label-width="80px">
                    <el-row :gutter="20" />
                    <el-row :gutter="20">
                      <el-col :span="6"><el-form-item label="收件人" prop="tail_order">
...
<script>
import { getTailOrderGoodsSpecialList, exportTailOrderGoodsSpecial, setTailOrderGoodsSpecial, recoverTailOrderGoodsSpecial } from '@/api/sales/tailgoods/togoods'
  ...
  data() {
    return {
      ...
      params: {
        page: 1,
        allSelectTag: 0,
        tail_order__order_status: 1,
        tail_order__mode_warehouse: 0
      },
      optionsProcessTag: [
        { label: '未处理', value: 0 },
        { label: '已处理', value: 4 }
  ...
  methods: {
    ...
    handleSetSpecial() {
      ...
      if (this.params.allSelectTag === 1) {
        setTailOrderGoodsSpecial(this.params).then(
          res => {
    ...
    handleSetRecover() {
      this.tableLoading = true
      if (this.params.allSelectTag === 1) {
        recoverTailOrderGoodsSpecial(this.params).then(
          res => {
            if (res.data.success !== 0) {
              this.$notify({
                title: '标记成功',
