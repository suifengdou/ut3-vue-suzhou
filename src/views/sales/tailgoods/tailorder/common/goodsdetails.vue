  ...
  <div class="tailorder-goods-common-container">
              ...
              <el-tooltip class="item" effect="dark" content="点击展开操作列表，可执行对应操作" placement="top-start">
                <el-dropdown split-button type="primary" placement="bottom-end" trigger="click">
                  ...
                  <el-dropdown-menu slot="dropdown" trigger="click">
                    <el-dropdown-item><el-button type="success" icon="el-icon-star-on" size="mini" round @click="handleSetSpecial">完成发货</el-button></el-dropdown-item>
                    <el-dropdown-item><el-button type="danger" icon="el-icon-star-off" size="mini" round @click="handleSetRecover">取消发货</el-button></el-dropdown-item>
                  </el-dropdown-menu>
                </el-dropdown>
              </el-tooltip>
    ...
    <div class="table-list">
      ...
      >
        ...
        >
          <template slot-scope="scope">
            <span>{{ scope.row.deliver_condition }}</span>
          </template>
        </el-table-column>
        ...
        >
          <template slot-scope="scope">
            <span>{{ scope.row.sent_district }}</span>
          </template>
        </el-table-column>
        <el-table-column
          label="创建者"
