<template>
  <div class="advance-verifyprestore-container">
          ...
          >
            <el-card class="box-card">
              ...
              <el-row :gutter="20">
                ...
                <!--<el-col :span="8">-->
                <!--<el-form-item label="类型" prop="balance">-->
                <!--<span>{{ formEdit.category.name }}</span>-->
                <!--</el-form-item>-->
                <!--</el-col>-->
              </el-row>
              <el-row :gutter="20">
                <el-col :span="8">
                  <el-form-item label="入账" prop="balance">
                    <span>{{ formEdit.revenue }}</span>
                  </el-form-item>
                </el-col>
                <el-col :span="8"><el-form-item label="支出" prop="balance">
                  <span>{{ formEdit.expenses }}</span>
                </el-form-item></el-col>
                <el-col :span="8"><el-form-item label="备注" prop="balance">
...
<script>
import { getVerifyprestoreList, exportVerifyprestore } from '@/api/sales/advance/verifyprestore'
...
export default {
  ...
  methods: {
    ...
    fetchData() {
      ...
      getVerifyprestoreList(this.params).then(
        res => {
