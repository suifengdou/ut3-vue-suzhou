...
<script>
  import {
    getExceptionIPOManageList,
    exportExceptionIPOManage,

  } from '@/api/int/purchase/exception/manage'
  ...
  export default {
    ...
    methods: {
      fetchData() {
        ...
        getExceptionIPOManageList(this.params).then(
          res => {
        ...
        this.$msgbox({
          ...
          beforeClose: (action, instance, done) => {
            if (action === 'confirm') {
              ...
              exportExceptionIPOManage(this.params).then(
                res => {
