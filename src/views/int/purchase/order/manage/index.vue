  ...
  <div class="intpurchaseorder-submit-container">
    ...
    <div class="table-list">
      ...
      >
        ...
        >
          <template slot-scope="scope">
            <span>{{ scope.row.exception_num }}</span>
          </template>
        </el-table-column>
        <el-table-column
          label="收款账户"
...
<script>
  import {
    getIntPurchaseOrderManageList,
    exportIntPurchaseOrderManage,
  } from '@/api/int/purchase/order/manage'
  ...
  export default {
    ...
    methods: {
      fetchData() {
        ...
        getIntPurchaseOrderManageList(this.params).then(
          res => {
        ...
        this.$msgbox({
          ...
          beforeClose: (action, instance, done) => {
            if (action === 'confirm') {
              ...
              exportIntPurchaseOrderManage(this.params).then(
                res => {
