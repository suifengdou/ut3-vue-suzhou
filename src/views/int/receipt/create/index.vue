        ...
        <el-card class="box-card">
          ...
          <el-row :gutter="20">
            <el-col :span="8"><el-form-item label="付款账户" prop="payment_account">
              <el-input v-model="formAdd.payment_account" placeholder="请输入付款账户" />
            </el-form-item></el-col>
            <el-col :span="8"><el-form-item label="付款ID" prop="payment_account_id">
              <el-input v-model="formAdd.payment_account_id" placeholder="请输入付款账户ID" />
            </el-form-item></el-col>
          </el-row>
          <el-row :gutter="20">
          ...
          <el-row :gutter="20">
            <el-col :span="8"><el-form-item label="交易流水号" prop="bank_sn">
              <el-input v-model="formAdd.bank_sn" placeholder="请输入交易流水号" />
            </el-form-item></el-col>
          ...
          <el-row :gutter="20">
            <el-col :span="16"><el-form-item label="信息说明" prop="information">
              <el-input v-model="formAdd.information" placeholder="请输入信息说明" />
            </el-form-item></el-col>
          </el-row>
          <el-row :gutter="20">
...
<script>
  import {
    getReceiptCreateList,
    createReceiptCreate,
    updateReceiptCreate,
    exportReceiptCreate,
    excelImportReceiptCreate,
    checkReceiptCreate,
    rejectReceiptCreate,
    photoImportReceiptCreate
  } from '@/api/int/receipt/create'
  ...
  export default {
    ...
    methods: {
      fetchData() {
        ...
        getReceiptCreateList(this.params).then(
          res => {
      ...
      handleSubmitEdit() {
        this.$refs.handleFormEdit.validate(valid => {
          ...
          updateReceiptCreate(id, data).then(
            () => {
      ...
      handleSubmitAdd() {
        ...
        createReceiptCreate(this.formAdd).then(
          () => {
            this.fetchData()
      ...
      importPhotoes() {
        ...
        this.tableLoading = true
        photoImportReceiptCreate(importformData, config).then(
          res => {
            this.$notify({
              title: '导入结果',
              message: res.data,
        ...
        this.$msgbox({
          ...
          beforeClose: (action, instance, done) => {
            if (action === 'confirm') {
              ...
              excelImportReceiptCreate(importformData, config).then(
                res => {
                  this.$notify({
                    title: '导入结果',
                    message: res.data,
        ...
        this.$msgbox({
          ...
          beforeClose: (action, instance, done) => {
            if (action === 'confirm') {
              instance.confirmButtonLoading = true
              instance.confirmButtonText = '执行中...'
              exportReceiptCreate(this.params).then(
                res => {
      ...
      handleCheck() {
        ...
        if (this.params.allSelectTag === 1) {
          checkReceiptCreate(this.params).then(
            res => {
        ...
        this.$msgbox({
          ...
          beforeClose: (action, instance, done) => {
            if (action === 'confirm') {
              ...
              instance.confirmButtonText = '执行中...'
              if (this.params.allSelectTag === 1) {
                rejectReceiptCreate(this.params).then(
                  res => {
                    if (res.data.successful !== 0) {
                      this.$notify({
                        title: '取消成功',
