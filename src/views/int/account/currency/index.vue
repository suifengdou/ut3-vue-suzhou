    ...
    >
      ...
      >
        <el-card class="box-card">
          ...
          <el-row :gutter="20">
            <el-col :span="8"><el-form-item label="货币名称" prop="name">
              <el-input v-model="formAdd.name" placeholder="请输入货币名称" />
            </el-form-item></el-col>
            <el-col :span="8"><el-form-item label="英文缩写" prop="abbreviation">
              <el-input v-model="formAdd.abbreviation" placeholder="请输入英文缩写" />
            </el-form-item></el-col>
          </el-row>
          <el-row :gutter="20">
            <el-col :span="8"><el-form-item label="符号" prop="symbol">
              <el-input v-model="formAdd.symbol" placeholder="请输入符号" />
            </el-form-item></el-col>
          </el-row>
        </el-card>
        <el-card class="box-card">
        ...
        <div class="handleFormEdit">
          ...
          >
            <el-card class="box-card">
              ...
              <el-row :gutter="20">
                <el-col :span="8"><el-form-item label="货币名称" prop="name">
                  <el-input v-model="formEdit.name" placeholder="请输入货币名称" />
                </el-form-item></el-col>
                <el-col :span="8"><el-form-item label="英文缩写" prop="abbreviation">
                  <el-input v-model="formEdit.abbreviation" placeholder="请输入英文缩写" />
                </el-form-item></el-col>
              </el-row>
              <el-row :gutter="20">
                <el-col :span="8"><el-form-item label="符号" prop="symbol">
                  <el-input v-model="formEdit.symbol" placeholder="请输入符号" />
                </el-form-item></el-col>
              </el-row>
            </el-card>
            <el-card class="box-card">
...
export default {
  ...
  methods: {
    ...
    fetchData() {
      ...
      getCurrencyList(this.params).then(
        res => {
    ...
    handleSubmitAdd() {
      ...
      createCurrency(this.formAdd).then(
        () => {
          this.fetchData()
