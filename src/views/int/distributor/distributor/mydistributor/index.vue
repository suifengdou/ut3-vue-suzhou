...
import {
  ...
  createMyDistributor,
  updateMyDistributor,
  excelImportMyDistributor,
  exportMyDistributor
} from '@/api/int/distributor/distributor/mydistributor'
...
export default {
  ...
  methods: {
    ...
    fetchData() {
      ...
      getMyDistributorList(this.params).then(
        res => {
    ...
    handleSubmitAdd() {
      ...
      createMyDistributor(this.formAdd).then(
        () => {
          this.fetchData()
    ...
    handleSubmitEdit() {
      this.$refs.FormEdit.validate(valid => {
        ...
        console.log(data)
        updateMyDistributor(id, data).then(
          () => {
