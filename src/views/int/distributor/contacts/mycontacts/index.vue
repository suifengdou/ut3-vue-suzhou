<template>
  <div class="mycontacts-container">
                  ...
                  <el-form ref="filterForm" :model="params" label-width="80px">
                    ...
                    <el-row :gutter="20">
                      <el-col :span="8"><el-form-item label="经销商" prop="distributor">
                        <el-input v-model="params.distributor__name" type="text" />
                      </el-form-item></el-col>
                      <el-col :span="4" />
                      <el-col :span="4" />
                    </el-row>
    ...
    <div class="table-list">
      ...
      >
        ...
        >
          <template slot-scope="scope">
            <div v-for="(item, i) in scope.row.contact_details">
              <el-tag size="mini" effect="dark"><span>{{ item.name }}：{{ item.content }}</span></el-tag>
            </div>
          </template>
        </el-table-column>
        <el-table-column
      ...
      >
        <el-card class="box-card">
          ...
          <el-row :gutter="20">
            ...
            <el-col :span="8"><el-form-item label="联系人" prop="name">
              <el-input v-model="formAdd.name" placeholder="请输入联系人" />
            </el-form-item></el-col>
          </el-row>

          <el-row :gutter="20">
            <el-col :span="8"><el-form-item label="职位" prop="position">
              <el-input v-model="formAdd.position" placeholder="请输入职位" />
            </el-form-item></el-col>
            <el-col :span="8"><el-form-item label="性别" prop="gender">
              <template>
                <el-select
        ...
        <el-card class="box-card">
          ...
          >
            ...
            <el-table-column label="联系方式" width="250" prop="name">
              <template slot-scope="scope">
                <el-input v-model="OrderDetailsList[scope.row.xh-1].name" type="text" />
              </template>
            </el-table-column>
            <el-table-column label="相关内容" width="250" prop="content">
              <template slot-scope="scope">
          ...
          >
            <el-card class="box-card">
              ...
              <el-row :gutter="20">
                ...
                <el-col :span="8"><el-form-item label="联系人" prop="name">
                  <el-input v-model="formEdit.name" placeholder="请输入联系人" />
                </el-form-item></el-col>
                <el-col :span="8"><el-form-item label="职位" prop="position">
                  <el-input v-model="formEdit.position" placeholder="请输入职位" />
                </el-form-item></el-col>
              </el-row>
              ...
              <el-row :gutter="20">
                ...
                <el-col :span="6"><el-form-item label="在职状态" prop="is_staff">
                  <template slot-scope="scope">
                    <el-switch
  ...
  export default {
    ...
    methods: {
      fetchData() {
        ...
        getMyContactsList(this.params).then(
          res => {
      ...
      handleEdit(values) {
        ...
        this.formEdit.gender = this.formEdit.gender.id

        this.OrderDetailsList = []
        let number
        for (number in this.formEdit.contact_details) {
          this.formEdit.contact_details[number].xh = number + 1
          this.OrderDetailsList.push(this.formEdit.contact_details[number])
        }
      ...
      handleSubmitEdit() {
        this.$refs.handleFormEdit.validate(valid => {
          ...
          console.log('在编辑')
          this.formEdit.contact_details = this.OrderDetailsList
          const { id, ...data } = this.formEdit
          console.log(this.OrderDetailsList)
          updateMyContacts(id, data).then(
            () => {
      ...
      handleSubmitAdd() {
        ...
        console.log(this.OrderDetailsList)
        this.formAdd.contact_details = this.OrderDetailsList
        createMyContacts(this.formAdd).then(
          () => {
            this.fetchData()
