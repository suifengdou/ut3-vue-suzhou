...
<script>
import { getUnitsVersionDetails } from '@/api/bom/units/unitsversiondetails'
import moment from 'moment'
export default {
  name: 'subunit-container',
  data() {
    return {
      DataList: [],
      tableLoading: false,
  ...
  methods: {
    ...
    fetchData() {
      ...
      getUnitsVersionDetails(this.params).then(
        res => {
