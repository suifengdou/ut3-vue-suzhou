  ...
  <div class="units-container">
    ...
    <div class="table-list">
      ...
      >
        ...
        >
          <template slot-scope="scope">
            <span>{{ scope.row.daily_capacity }}</span>
          </template>
        </el-table-column>
        <el-table-column
          label="成型周期"
        ...
        >
          <template slot-scope="scope">
            <span>{{ scope.row.cycle_time }}</span>
          </template>
        </el-table-column>
        <el-table-column
          label="备注"
...
<script>
import { getMiddlePartsVersion } from '@/api/bom/middleparts/middlepartsversion'
import moment from 'moment'
export default {
  name: 'middlepartsversion-container',
  data() {
    return {
      DataList: [],
      tableLoading: false,
  ...
  methods: {
    ...
    fetchData() {
      ...
      getMiddlePartsVersion(this.params).then(
        res => {
