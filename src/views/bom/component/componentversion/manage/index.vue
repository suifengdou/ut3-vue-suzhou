<template>
  <div class="componentversion-container">
...
<script>
import { getComponentVersion } from '@/api/bom/component/componentversion'
import moment from 'moment'
export default {
  name: 'units-container',
  data() {
    return {
      DataList: [],
      tableLoading: false,
  ...
  methods: {
    ...
    fetchData() {
      ...
      getComponentVersion(this.params).then(
        res => {
