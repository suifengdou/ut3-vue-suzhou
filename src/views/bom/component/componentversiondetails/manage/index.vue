<template>
  <div class="componentversiondetails-container">
...
<script>
import { getComponentVersionDetails } from '@/api/bom/component/componentversiondetails'
import moment from 'moment'
export default {
  name: 'componentversiondetails-container',
  data() {
    return {
      DataList: [],
      tableLoading: false,
  ...
  methods: {
    ...
    fetchData() {
      ...
      getComponentVersionDetails(this.params).then(
        res => {
