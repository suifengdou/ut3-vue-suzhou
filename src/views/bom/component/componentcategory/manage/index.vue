              ...
              <el-collapse-item>
                ...
                <div class="block">
                  <el-form ref="filterForm" :model="params" label-width="80px">
                    <el-row :gutter="20">
                      <el-col :span="6"><el-form-item label="组项类型名" prop="name">
                        <el-input v-model="params.name" type="text" />
                      </el-form-item></el-col>
                      <el-col :span="6"><el-form-item label="子项类别" prop="subunit_category">
                        <el-select
                          v-model="params.subunit_category"
                          filterable
                        ...
                        >
                          <el-option
                            v-for="item in optionsSubunitCategory"
                            :key="item.value"
                            :label="item.label"
                            :value="item.value"
                          />
...
<script>
import { getComponetCategory, createComponetCategory, updateComponetCategory } from '@/api/bom/component/componentcategory'
...
export default {
  ...
  methods: {
    ...
    fetchData() {
      ...
      getComponetCategory(this.params).then(
        res => {
    ...
    handleSubmitAdd() {
      ...
      createComponetCategory(this.formAdd).then(
        () => {
          this.fetchData()
    ...
    handleSubmitEdit() {
      this.$refs.FormEdit.validate(valid => {
        ...
        // }
        updateComponetCategory(id, data).then(
          () => {
