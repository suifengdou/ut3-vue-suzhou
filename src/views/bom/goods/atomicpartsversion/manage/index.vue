  ...
  <div class="units-container">
    ...
    <div class="table-list">
      ...
      >
        ...
        >
          <template slot-scope="scope">
            <span>{{ scope.row.atomic_parts.name }}</span>
          </template>
        </el-table-column>
        <el-table-column
          label="中间件版本"
          prop="middlepartsversion"
          sortable="custom"
          :sort-orders="['ascending','descending']"
        >
          <template slot-scope="scope">
            <span>{{ scope.row.middlepartsversion.name }}</span>
          </template>
        </el-table-column>
        <el-table-column
          label="是否喷漆"
        ...
        <el-table-column
          label="色号"
          prop="lacquer_color_number"
          sortable="custom"
          :sort-orders="['ascending','descending']"
        >
          <template slot-scope="scope">
            <span>{{ scope.row.lacquer_color_number }}</span>
          </template>
        </el-table-column>
        <el-table-column
          label="工艺内容"
        ...
        >
          <template slot-scope="scope">
            <span>{{ scope.row.craft_content }}</span>
          </template>
        </el-table-column>
        <el-table-column
          label="是否单元"
        ...
        >
          <template slot-scope="scope">
            <span>{{ scope.row.cell_number }}</span>
          </template>
        </el-table-column>
        <el-table-column
          label="是否套件"
        ...
        >
          <template slot-scope="scope">
            <span>{{ scope.row.kit_number }}</span>
          </template>
        </el-table-column>
        <el-table-column
          label="是否默认"
...
<script>
import { getAtomicPartsVersion } from '@/api/bom/goods/atomicpartsversion'
  ...
  methods: {
    ...
    fetchData() {
      ...
      if (typeof (this.params.created_time) !== 'undefined') {
        if (this.params.created_timed.length === 2) {
      ...
      getAtomicPartsVersion(this.params).then(
        res => {
