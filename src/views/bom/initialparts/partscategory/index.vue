<template>
  <div class="bom-partcategory-container">
        ...
        <el-col :span="5" class="titleBar">
          <div class="grid-content bg-purple">
            <el-tooltip class="item" effect="dark" content="快捷搜索" placement="top-start">
              <el-input v-model="params.name" class="grid-content bg-purple" placeholder="请输入系列名称" @keyup.enter.native="fetchData">
                ...
                <div class="block">
                  <el-form ref="filterForm" :model="params" label-width="80px">
                    <el-row :gutter="20">
                     ...
                     <el-row :gutter="20">
                      <el-col :span="6"><el-form-item label="系列名称" prop="name">
                        <el-input v-model="params.name" type="text" />
                      </el-form-item></el-col>
                      <el-col :span="6"><el-form-item label="系列编码" prop="line_id">
                        <el-input v-model="params.line_id" type="text" />
                      </el-form-item></el-col>
                      <el-col :span="6" />
                      <el-col :span="6" />
                    </el-row>
    ...
    >
      ...
      >
        <el-card class="box-card">
          ...
          <el-row :gutter="20">
            <el-col :span="8">            
              <el-form-item label="是否成本" prop="is_cost">
                <el-switch
                  v-model="formAdd.is_cost"
                  active-color="#13ce66"
                  inactive-color="#ff4949"
                />
              </el-form-item>
            ...
            <el-card class="box-card">
              ...
              <el-row :gutter="20">
                <el-col :span="8"><el-form-item label="物料类型" prop="name">
                  <el-input v-model="formEdit.name" placeholder="物料类型" />
                </el-form-item></el-col>
              </el-row>
...
export default {
  ...
  methods: {
    fetchData() {
      ...
      getPartsCategory(this.params).then(
        res => {
    ...
    handleSubmitEdit() {
      this.$refs.handleFormEdit.validate(valid => {
        ...
        let attrStr
        console.log(data)
        const transFieldStr = ['category', 'creator']
        for (attrStr in transFieldStr) {
          data[transFieldStr[attrStr]] = data[transFieldStr[attrStr]].id
        }
        console.log(data)
        updatePartsCategory(id, data).then(
          () => {
    ...
    // 递交添加
    handleSubmitAdd() {
      createPartsCategory(this.formAdd).then(
        () => {
          this.fetchData()
