<template>
  <div class="mouldversion-container">
    ...
    <div class="table-list">
      ...
      >
        ...
        >
          <template slot-scope="scope">
            <span>{{ scope.row.mould.name }}</span>
          </template>
        </el-table-column>
        <el-table-column
          label="文件名"
...
<script>
import { getMouldVersion } from '@/api/bom/mould/mouldversion'
import moment from 'moment'
export default {
  name: 'mouldversion-container',
  data() {
    return {
      DataList: [],
      tableLoading: false,
  ...
  methods: {
    ...
    fetchData() {
      ...
      getMouldVersion(this.params).then(
        res => {
