  ...
  <div class="mould-container">
    ...
    <div class="table-list">
      ...
      >
        ...
        >
          <template slot-scope="scope">
            <span>{{ scope.row.cavity_num }}</span>
          </template>
        </el-table-column>
        <el-table-column
          label="浇口类型"
        ...
        >
          <template slot-scope="scope">
            <span>{{ scope.row.cavity_steel }}</span>
          </template>
        </el-table-column>
        <el-table-column
          label="后模钢料"
        ...
        >
          <template slot-scope="scope">
            <span>{{ scope.row.core_steel }}</span>
          </template>
        </el-table-column>
        <el-table-column
          label="后模钢料"
        ...
        >
          <template slot-scope="scope">
            <span>{{ scope.row.difficulty_level.name }}</span>
          </template>
        </el-table-column>
        <el-table-column
          label="模具生产商"
        ...
        >
          <template slot-scope="scope">
            <span>{{ scope.row.mould_supplier.name }}</span>
          </template>
        </el-table-column>
        <el-table-column
          label="寿命"
...
<script>
import { getMould } from '@/api/bom/mould/mould'
import moment from 'moment'
export default {
  name: 'mould-container',
  data() {
    return {
      DataList: [],
      tableLoading: false,
