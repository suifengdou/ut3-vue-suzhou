              ...
              <el-collapse-item>
                ...
                <div class="block">
                  <el-form ref="filterForm" :model="params" label-width="80px">
                    <el-row :gutter="20">
                      <el-col :span="6"><el-form-item label="类别" prop="category">
                        <template>
                          <el-select
    ...
    >
      ...
      >
        <el-card class="box-card">
          ...
          <el-row :gutter="20">
            <el-col :span="8"><el-form-item label="系列类型" prop="category">
              <template>
                <el-select
          ...
          >
            <el-card class="box-card">
              ...
              <el-row :gutter="20">
                ...
                <el-col :span="8"><el-form-item label="系列名称" prop="name">
                  <el-input v-model="formEdit.name" placeholder="系列名称" />
                </el-form-item></el-col>
              </el-row>
...
export default {
  ...
  methods: {
    fetchData() {
      ...
      getProductLineList(this.params).then(
        res => {
    ...
    remoteMethodCategory(query) {
      if (query !== '') {
        ...
        setTimeout(() => {
          ...
          getProductLineCategoryList(paramsSearch).then(
            res => {
              this.optionsCategory = res.data.results.map(item => {
