<template>
  <div class="advance-account-container">
              ...
              <el-row :gutter="20">
                ...
                <el-col :span="8">
                  <el-form-item label="用户" prop="user">
                    <template v-if="formEdit.user != undefined">
                      <span>{{ formEdit.user.name }}</span>
                    </template>
                  </el-form-item>
                </el-col>
              </el-row>
...
<script>
import { getMyAccountList } from '@/api/sales/advance/account'
...
export default {
  ...
  methods: {
    ...
    fetchData() {
      ...
      getMyAccountList(this.params).then(
        res => {
