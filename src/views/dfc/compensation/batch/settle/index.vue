<template>
  <div class="batch-compensation-settle-container">
...
<script>
  import {
    getBatchCompensationSettleList,
    createBatchCompensationSettle,
    updateBatchCompensationSettle,
    exportBatchCompensationSettle,
    excelImportBatchCompensationSettle,
    checkBatchCompensationSettle,
  } from '@/api/dfc/compensation/batch/batchcompensationsettle'
  ...
  export default {
    name: 'batch-compensation-settle',
    data() {
      return {
        DataList: [],
        tableLoading: false,
    ...
    methods: {
      fetchData() {
        ...
        getBatchCompensationSettleList(this.params).then(
          res => {
      ...
      handleCheck() {
        ...
        if (this.params.allSelectTag === 1) {
          checkBatchCompensationSettle(this.params).then(
            res => {
