        ...
        <el-col :span="5" class="titleBar">
          <div class="grid-content bg-purple">
            <el-tooltip class="item" effect="dark" content="快捷搜索" placement="top-start">
              <el-input v-model="params.batch_order__order_id" class="grid-content bg-purple" placeholder="请输入批次号" @keyup.enter.native="fetchData">
...
<script>
import {
  getBCDetailSubmitList,
  createBCDetailSubmit,
  updateBCDetailSubmit,
  exportBCDetailSubmit,
  excelImportBCDetailSubmit,
  checkBCDetailSubmit,
  rejectBCDetailSubmit,
  setSpecialBCDetailSubmit,
  resetTagBCDetailSubmit
} from '@/api/dfc/compensation/batchdetail/bcdetailsubmit'
...
export default {
  ...
  methods: {
    fetchData() {
      ...
      getBCDetailSubmitList(this.params).then(
        res => {
    ...
    confirmCategory(row) {
      ...
      console.log(data)
      updateBCDetailSubmit(id, data).then(
        () => {
          this.$notify({
            title: '修改成功',
            type: 'success',
    ...
    handleSubmitAdd() {
      ...
      createBCDetailSubmit(this.formAdd).then(
        () => {
          this.fetchData()
      ...
      this.$msgbox({
        ...
        beforeClose: (action, instance, done) => {
          if (action === 'confirm') {
            ...
            exportBCDetailSubmit(this.params).then(
              res => {
        ...
        beforeClose: (action, instance, done) => {
          if (action === 'confirm') {
            ...
            if (this.params.allSelectTag === 1) {
              rejectBCDetailSubmit(this.params).then(
                res => {
