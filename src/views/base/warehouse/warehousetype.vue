...
<script>
import { getWarehouseTypeList, createWarehouseType, updateWarehouseType } from '@/api/base/warehouse'
...
export default {
  ...
  methods: {
    ...
    fetchData() {
      ...
      getWarehouseTypeList(this.params).then(
        res => {
    ...
    handleSubmitAdd() {
      ...
      createWarehouseType(this.formAdd).then(
        () => {
          this.fetchData()
    ...
    handleSubmitEdit() {
      this.$refs.FormEdit.validate(valid => {
        ...
        console.log(data)
        updateWarehouseType(id, data).then(
          () => {
