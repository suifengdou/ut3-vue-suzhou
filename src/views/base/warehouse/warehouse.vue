  ...
  <div class="shop-container">
    ...
    <div class="table-list">
      ...
      >
        ...
        >
          <template slot-scope="scope">
            <span>{{ scope.row.warehouse_id }}</span>
          </template>
        </el-table-column>
        <el-table-column
          label="城市"
      ...
      >
        <el-card class="box-card">
          ...
          <el-row :gutter="20">
            ...
            <el-col :span="8"><el-form-item label="仓库ID" prop="warehouse_id">
              <el-input v-model="formAdd.warehouse_id" placeholder="请输入类型" />
            </el-form-item></el-col>
          </el-row>
          <el-row :gutter="20">
            <el-col :span="8"><el-form-item label="仓库类型" prop="category">
              <template>
                <el-select
          ...
          >
            <el-card class="box-card">
              ...
              <el-row :gutter="20">
                ...
                <el-col :span="8"><el-form-item label="仓库ID" prop="warehouse_id">
                  <el-input v-model="formEdit.warehouse_id" placeholder="请输入类型" />
                </el-form-item></el-col>
              </el-row>
              <el-row :gutter="20">
                <el-col :span="8"><el-form-item label="仓库类型" prop="category">
...
export default {
  ...
  methods: {
    ...
    fetchData() {
      ...
      getWarehouseList(this.params).then(
        res => {
    ...
    handleSubmitAdd() {
      ...
      createWarehouse(this.formAdd).then(
        () => {
          this.fetchData()
    ...
    handleEdit(values) {
      ...
      this.optionsType = [{ label: this.formEdit.category.name, value: this.formEdit.category.id }]
    ...
    remoteMethodType(query) {
      if (query !== '') {
        setTimeout(() => {
          ...
          getWarehouseTypeList(paramsSearch).then(
            res => {
              this.optionsType = res.data.results.map(item => {
