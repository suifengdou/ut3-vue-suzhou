...
<script>
import { getPlatformList, createPlatform, updatePlatform } from '@/api/base/platform'
export default {
  ...
  methods: {
    ...
    fetchData() {
      ...
      getPlatformList(this.params).then(
        res => {
    ...
    handleSubmitAdd() {
      ...
      createPlatform(this.formAdd).then(
        () => {
          this.fetchData()
