              ...
              <el-collapse-item>
                ...
                <div class="block">
                  <el-form ref="filterForm" :model="params" label-width="80px">
                    <el-row :gutter="20">
                      <el-col :span="6"><el-form-item label="中心名称" prop="name">
    ...
    >
      ...
      >
        <el-card class="box-card">
          ...
          <el-row :gutter="20">
            <el-col :span="8"><el-form-item label="中心名称" prop="name">
              <el-input v-model="formAdd.name" placeholder="请输入名称" />
            </el-form-item></el-col>
            <el-col :span="8"><el-form-item label="中心ID" prop="c_id">
              <el-input v-model="formAdd.c_id" placeholder="请输入中心ID" />
            </el-form-item></el-col>
          </el-row>
        </el-card>
        <el-card class="box-card">
          ...
          >
            <el-card class="box-card">
              ...
              <el-row :gutter="20">
                ...
                <el-col :span="8"><el-form-item label="中心ID" prop="c_id">
                  <el-input v-model="formEdit.c_id" placeholder="请输入ID" />
                </el-form-item></el-col>
              </el-row>
            </el-card>
            <el-card class="box-card">
...
<script>
import { getCenterList, createCenter, updateCenter } from '@/api/base/center'
export default {
  ...
  methods: {
    ...
    fetchData() {
      ...
      getCenterList(this.params).then(
        res => {
    ...
    handleSubmitAdd() {
      ...
      createCenter(this.formAdd).then(
        () => {
          this.fetchData()
