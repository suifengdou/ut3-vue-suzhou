<template>
  <div class="phototypeexecuteprojectdetails-purchase-container">
              ...
              <el-tooltip class="item" effect="dark" content="点击展开操作列表，可执行对应操作" placement="top-start">
                <el-dropdown split-button type="primary" placement="bottom-end" trigger="click">
                  ...
                  <el-dropdown-menu slot="dropdown" trigger="click">
                    ...
                    <el-dropdown-item><el-button type="success" icon="el-icon-check" size="mini" round @click="handleResetTag">清楚状态</el-button></el-dropdown-item>
...
<script>
import {
  getPhototypeExecuteProjectDetailsPurchase,
  updatePhototypeExecuteProjectDetailsPurchase,
  exportPhototypeExecuteProjectDetailsPurchase,
  excelImportPhototypeExecuteProjectDetailsPurchase,
  checkPhototypeExecuteProjectDetailsPurchase,
  rejectPhototypeExecuteProjectDetailsPurchase,
  photoImportPhototypeExecuteProjectDetailsPurchase,
  setTagPhototypeExecuteProjectDetailsPurchase,
  resetTagPhototypeExecuteProjectDetailsPurchase
} from '@/api/project/phototypeexecuteproject/details/purchase'
...
export default {
  name: 'purchasePhototypeExecuteProjectDetails',
  ...
  methods: {
    fetchData() {
      ...
      getPhototypeExecuteProjectDetailsPurchase(this.params).then(
        res => {
    ...
    importPhotoes() {
      ...
      this.tableLoading = true
      photoImporPhototypeExecuteProjectDetailsPurchase(importformData, config).then(
        res => {
          this.$notify({
            title: '导入结果',
            message: res.data,
      ...
      this.$msgbox({
        ...
        beforeClose: (action, instance, done) => {
          if (action === 'confirm') {
            ...
            excelImportPhototypeExecuteProjectDetailsPurchase(importformData, config).then(
              res => {
                this.$notify({
                  title: '导入结果',
                  message: res.data,
      ...
      this.$msgbox({
        ...
        beforeClose: (action, instance, done) => {
          if (action === 'confirm') {
            instance.confirmButtonLoading = true
            instance.confirmButtonText = '执行中...'
            exportPhototypeExecuteProjectDetailsPurchase(this.params).then(
              res => {
    ...
    handleCheck() {
      ...
      if (this.params.allSelectTag === 1) {
        checkPhototypeExecuteProjectDetailsPurchase(this.params).then(
          res => {
    ...
    handleSetConfirm() {
      this.tableLoading = true
      if (this.params.allSelectTag === 1) {
        setTagPhototypeExecuteProjectDetailsPurchase(this.params).then(
          res => {
            if (res.data.successful !== 0) {
              this.$notify({
                title: '审核成功',
    ...
    handleResetTag() {
      this.tableLoading = true
      if (this.params.allSelectTag === 1) {
        resetTagPhototypeExecuteProjectDetailsPurchase(this.params).then(
          res => {
            if (res.data.successful !== 0) {
              this.$notify({
                title: '审核成功',
      ...
      this.$msgbox({
        ...
        beforeClose: (action, instance, done) => {
          if (action === 'confirm') {
            ...
            instance.confirmButtonText = '执行中...'
            if (this.params.allSelectTag === 1) {
              rejectPhototypeExecuteProjectDetailsPurchase(this.params).then(
                res => {
                  if (res.data.successful !== 0) {
                    this.$notify({
                      title: '驳回成功',
    ...
    submitPrice(row) {
      ...
      if (!(!isNaN(parseFloat(price)) && isFinite(price))) {
        ...
        updatePhototypeExecuteProjectDetailsPurchase(id, data).then(
          () => {
