<template>
  <div class="phototypeprojectdetails-make-container">
...
<script>
import {
  getPhototypeProjectDetailsMake,
  updatePhototypeProjectDetailsMake,
  exportPhototypeProjectDetailsMake,
  excelImportPhototypeProjectDetailsMake,
  checkPhototypeProjectDetailsMake,
  rejectPhototypeProjectDetailsMake,
  photoImportPhototypeProjectDetailsMake,
  setTagPhototypeProjectDetailsMake,
  resetTagPhototypeProjectDetailsMake
} from '@/api/project/phototypeproject/details/make'
...
export default {
  name: 'makePhototypeProjectDetails',
  ...
  methods: {
    fetchData() {
      ...
      getPhototypeProjectDetailsMake(this.params).then(
        res => {
    ...
    handleConfirmEdit() {
      this.$refs.handleFormEdit.validate(valid => {
        ...
        console.log(data)
        updatePhototypeProjectDetailsMake(id, data).then(
          () => {
            this.$notify({
              title: '更新成功',
              type: 'success',
    ...
    importPhotoes() {
      ...
      this.tableLoading = true
      photoImporPhototypeProjectDetailsMake(importformData, config).then(
        res => {
          this.$notify({
            title: '导入结果',
            message: res.data,
    ...
    handlePhotoView(userValue) {
      ...
      getFileDetailsPhototypeProjectDetails(data).then(
        res => {
          this.$notify({
            title: '查询成功',
            type: 'success',
      ...
      this.$msgbox({
        ...
        beforeClose: (action, instance, done) => {
          if (action === 'confirm') {
            ...
            exportPhototypeProjectDetailsMake(this.params).then(
              res => {
    ...
    handleCheck() {
      ...
      if (this.params.allSelectTag === 1) {
        checkPhototypeProjectDetailsMake(this.params).then(
          res => {
      ...
      this.$msgbox({
        ...
        beforeClose: (action, instance, done) => {
          if (action === 'confirm') {
            ...
            instance.confirmButtonText = '执行中...'
            if (this.params.allSelectTag === 1) {
              rejectPhototypeProjectDetailsMake(this.params).then(
                res => {
                  if (res.data.successful !== 0) {
                    this.$notify({
                      title: '驳回成功',
