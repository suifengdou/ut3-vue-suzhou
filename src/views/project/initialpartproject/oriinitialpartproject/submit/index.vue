<template>
  <div class="origininitialpartproject-submit-container">
              ...
              <el-tooltip class="item" effect="dark" content="点击展开操作列表，可执行对应操作" placement="top-start">
                <el-dropdown split-button type="primary" placement="bottom-end" trigger="click">
                  ...
                  <el-dropdown-menu slot="dropdown" trigger="click">
                    <el-dropdown-item><el-button type="success" icon="el-icon-check" size="mini" round @click="handleSetNumber">确认物料</el-button></el-dropdown-item>
                    ...
                    <el-dropdown-item><el-button type="success" icon="el-icon-check" size="mini" round @click="handleHandleReject">处理驳回</el-button></el-dropdown-item>
                    <el-dropdown-item><el-button type="danger" icon="el-icon-close" size="mini" round @click="handleReject">取消物料</el-button></el-dropdown-item>
                  </el-dropdown-menu>
                </el-dropdown>
              </el-tooltip>
        ...
        <el-col :span="7" class="titleBar">
          <div class="grid-content bg-purple">
            <el-tooltip class="item" effect="dark" content="点击弹出新建界面" placement="top-start">
              <el-button type="primary" @click="add">新增原初物料项目</el-button>
            </el-tooltip>
          </div>
    ...
    >
      ...
      >
        <el-card class="box-card">
          ...
          <el-row :gutter="20">
            <el-col :span="8"><el-form-item label="原初物料" prop="name">
              <el-input v-model="formAdd.name" placeholder="请输入原初物料" />
            </el-form-item></el-col>
            <el-col :span="8"><el-form-item label="原初物料编码" prop="code">
              <el-input v-model="formAdd.code" placeholder="请输入原初物料编码" />
            </el-form-item></el-col>
          </el-row>
          <el-row :gutter="20">
            <el-col :span="8"><el-form-item label="单据类型" prop="order_category">
            ...
            <el-col :span="8"><el-form-item label="文件名" prop="file_name">
              <el-input v-model="formAdd.file_name" placeholder="请输入文件名" />
            </el-form-item></el-col>
          </el-row>
          <el-row :gutter="20">
            <el-col :span="8"><el-form-item label="组项项目" prop="component_project">
              <template>
                <el-select
                  v-model="formAdd.component_project"
                  filterable
                  default-first-option
                  remote
                  reserve-keyword
          ...
          <el-row :gutter="20">
            <el-col :span="8"><el-form-item label="爆炸图号" prop="diagram_number">
              <el-input v-model="formAdd.diagram_number" placeholder="请输入爆炸图号" />
            </el-form-item></el-col>
            <el-col :span="8"><el-form-item label="规格" prop="specification">
              <el-input v-model="formAdd.specification" placeholder="请输入规格" />
            </el-form-item></el-col>
          </el-row>
          <el-row :gutter="20">
            <el-col :span="8"><el-form-item label="工艺" prop="technology">
              <el-input v-model="formAdd.technology" placeholder="请输入工艺" />
            </el-form-item></el-col>
            <el-col :span="8"><el-form-item label="原材料" prop="material">
              <template>
                <el-select
                  v-model="formAdd.material"
                  filterable
                  default-first-option
                  remote
                  reserve-keyword
          ...
          <el-row :gutter="20">
            <el-col :span="8"><el-form-item label="成型收缩率" prop="shrinkage">
              <el-input v-model="formAdd.shrinkage" placeholder="请输入成型收缩率" />
            </el-form-item></el-col>
            <el-col :span="8"><el-form-item label="材料色号" prop="material_color_number">
              <el-input v-model="formAdd.material_color_number" placeholder="请输入材料色号" />
            </el-form-item></el-col>
          </el-row>
          <el-row :gutter="20">
            <el-col :span="8"><el-form-item label="用量" prop="quantity">
              <el-input v-model="formAdd.quantity" placeholder="请输入用量" />
            </el-form-item></el-col>
            <el-col :span="8"><el-form-item label="克重" prop="weight">
              <el-input v-model="formAdd.weight" placeholder="请输入克重" />
            </el-form-item></el-col>
          </el-row>
          <el-row :gutter="20">
            <el-col :span="8"><el-form-item label="是否喷漆" prop="is_lacquered">
              <template slot-scope="scope">
                <el-switch
                  v-model="formAdd.is_lacquered"
                  active-color="#13ce66"
                  inactive-color="#ff4949"
                />
              </template>
            </el-form-item></el-col>
            <el-col :span="8"><el-form-item label="是否组件" prop="is_group">
              <template slot-scope="scope">
                <el-switch
                  v-model="formAdd.is_group"
                  active-color="#13ce66"
                  inactive-color="#ff4949"
                />
              </template>
          ...
          <el-row :gutter="20">
            <el-col :span="8"><el-form-item label="色号" prop="color_number">
              <el-input v-model="formAdd.color_number" placeholder="请输入色号" />
            </el-form-item></el-col>
            <el-col :span="8"><el-form-item label="分组编码" prop="group_code">
              <el-input v-model="formAdd.group_code" placeholder="请输入分组编码" />
            </el-form-item></el-col>
          </el-row>
          <el-row :gutter="20">
            <el-col :span="8"><el-form-item label="是否制板" prop="is_making">
              <template slot-scope="scope">
                <el-switch
                  v-model="formAdd.is_making"
                  active-color="#13ce66"
                  inactive-color="#ff4949"
                />
              </template>
          ...
          <el-row :gutter="20">
            <el-col :span="16"><el-form-item label="备注" prop="memo">
              <el-input v-model="formAdd.memo" placeholder="备注" />
            </el-form-item></el-col>
            <el-col :span="8" />
          </el-row>
        </el-card>
      ...
      <template>
        <div class="handleFormEdit">
          ...
          >
            ...
            <el-row :gutter="20">
              <el-col :span="8"><el-form-item label="原初物料" prop="name">
                <el-input v-model="formEdit.name" placeholder="请输入原初物料" />
              </el-form-item></el-col>
              <el-col :span="8"><el-form-item label="原初物料编码" prop="code">
                <el-input v-model="formEdit.code" placeholder="请输入原初物料编码" />
              </el-form-item></el-col>
            </el-row>
            <el-row :gutter="20">
              <el-col :span="8"><el-form-item label="单据类型" prop="order_category">
                <el-select v-model="formEdit.order_category" placeholder="请选择级别">
                  <el-option
                    v-for="item in optionsOrderCategory"
                    :key="item.value"
                    :label="item.label"
              ...
              <el-col :span="8"><el-form-item label="文件名" prop="file_name">
                <el-input v-model="formEdit.file_name" placeholder="请输入文件名" />
              </el-form-item></el-col>
            </el-row>
            <el-row :gutter="20">
              <el-col :span="8"><el-form-item label="组项项目" prop="component_project">
                <template>
                  <el-select
                    v-model="formEdit.component_project"
                    filterable
                    default-first-option
                    remote
                    reserve-keyword
            ...
            <el-row :gutter="20">
              <el-col :span="8"><el-form-item label="爆炸图号" prop="diagram_number">
                <el-input v-model="formEdit.diagram_number" placeholder="请输入爆炸图号" />
              </el-form-item></el-col>
              <el-col :span="8"><el-form-item label="规格" prop="specification">
                <el-input v-model="formEdit.specification" placeholder="请输入规格" />
              </el-form-item></el-col>
            </el-row>
            <el-row :gutter="20">
              <el-col :span="8"><el-form-item label="工艺" prop="technology">
                <el-input v-model="formEdit.technology" placeholder="请输入工艺" />
              </el-form-item></el-col>
              <el-col :span="8"><el-form-item label="原材料" prop="material">
                <template>
                  <el-select
                    v-model="formEdit.material"
                    filterable
                    default-first-option
                    remote
                    clearable
            ...
            <el-row :gutter="20">
              <el-col :span="8"><el-form-item label="成型收缩率" prop="shrinkage">
                <el-input v-model="formEdit.shrinkage" placeholder="请输入成型收缩率" />
              </el-form-item></el-col>
              <el-col :span="8"><el-form-item label="材料色号" prop="material_color_number">
                <el-input v-model="formEdit.material_color_number" placeholder="请输入材料色号" />
              </el-form-item></el-col>
            </el-row>
            <el-row :gutter="20">
              <el-col :span="8"><el-form-item label="用量" prop="quantity">
                <el-input v-model="formEdit.quantity" placeholder="请输入用量" />
              </el-form-item></el-col>
              <el-col :span="8"><el-form-item label="克重" prop="weight">
                <el-input v-model="formEdit.weight" placeholder="请输入克重" />
              </el-form-item></el-col>
            </el-row>
            <el-row :gutter="20">
              <el-col :span="8"><el-form-item label="是否喷漆" prop="is_lacquered">
            ...
            <el-row :gutter="20">
              <el-col :span="8"><el-form-item label="色号" prop="color_number">
                <el-input v-model="formEdit.color_number" placeholder="请输入色号" />
              </el-form-item></el-col>
              <el-col :span="8"><el-form-item label="分组编码" prop="group_code">
                <el-input v-model="formEdit.group_code" placeholder="请输入分组编码" />
              </el-form-item></el-col>
            </el-row>
            <el-row :gutter="20">
              <el-col :span="8"><el-form-item label="是否制板" prop="is_making">
...
<script>
import {
  getOriginInitialPartSubmit,
  createOriginInitialPartSubmit,
  updateOriginInitialPartSubmit,
  exportOriginInitialPartSubmit,
  excelImportOriginInitialPartSubmit,
  checkOriginInitialPartSubmit,
  rejectOriginInitialPartSubmit,
  photoImportOriginInitialPartSubmit,
  setNumberOriginInitialPartSubmit,
  handleRejectkOriginInitialPartSubmit
} from '@/api/project/initialpartproject/oriinitialpartproject/submit'
import { getLogOriginInitialPartProject, getFileDetailsOriginInitialPartProject } from '@/api/project/initialpartproject/oriinitialpartproject/manage'
...
import { getUnitProjectDevelop } from '@/api/project/unitproject/unitproject/develop'
import { getSubUnitProjectDevelop } from '@/api/project/subunitproject/develop'
import { getComponentProjectDevelop } from '@/api/project/componentproject/develop'
import { deleteOIPPFile } from '@/api/project/initialpartproject/oriinitialpartproject/oippfile'
import { getMaterialList } from '@/api/bom/material/material'
import { getOriginInitialPart } from '@/api/project/initialpartproject/oriinitialpartproject/submit'
import moment from 'moment'
import XLSX from 'xlsx'
export default {
  name: 'submitOriginInitialPartProject',
  ...
  methods: {
    fetchData() {
      ...
      getOriginInitialPartSubmit(this.params).then(
        res => {
    ...
    handleEdit(values) {
      ...
      this.optionsPartsCategory = [{ label: this.formEdit.category.name, value: this.formEdit.category.id }]
      this.formEdit.category = this.formEdit.category.id
      this.optionsComponentProject = [{ label: this.formEdit.component_project.name, value: this.formEdit.component_project.id }]
      this.formEdit.component_project = this.formEdit.component_project.id
      this.optionsMaterial = [{ label: this.formEdit.material.name, value: this.formEdit.material.id }]
      this.formEdit.material = this.formEdit.material.id

      this.formEdit.product_line = this.formEdit.product_line.id
      this.formEdit.unit_project = this.formEdit.unit_project.id
      this.formEdit.subunit_project = this.formEdit.subunit_project.id
    ...
    handleSubmitEdit() {
      this.$refs.handleFormEdit.validate(valid => {
        ...
        let attrStr
        console.log(data)
        const transFieldStr = ['creator', 'mistake_tag']
        if (data.material === -1) {
        ...
        console.log(data)
        updateOriginInitialPartSubmit(id, data).then(
          () => {
            this.$notify({
              title: '更新成功',
              type: 'success',
    ...
    handleSubmitAdd() {
      ...
      createOriginInitialPartSubmit(this.formAdd).then(
        () => {
          this.fetchData()
    ...
    importPhotoes() {
      ...
      this.tableLoading = true
      photoImportOriginInitialPartSubmit(importformData, config).then(
        res => {
          this.$notify({
            title: '导入结果',
            message: res.data,
      ...
      this.$msgbox({
        ...
        beforeClose: (action, instance, done) => {
          if (action === 'confirm') {
            ...
            excelImportOriginInitialPartSubmit(importformData, config).then(
              res => {
                this.$notify({
                  title: '导入结果',
                  message: res.data,
      ...
      this.$msgbox({
        ...
        beforeClose: (action, instance, done) => {
          if (action === 'confirm') {
            instance.confirmButtonLoading = true
            instance.confirmButtonText = '执行中...'
            exportOriginInitialPartSubmit(this.params).then(
              res => {
    ...
    handleSetNumber() {
      ...
      if (this.params.allSelectTag === 1) {
        setNumberOriginInitialPartSubmit(this.params).then(
          res => {
    ...
    handleCheck() {
      this.tableLoading = true
      if (this.params.allSelectTag === 1) {
        checkOriginInitialPartSubmit(this.params).then(
          res => {
            if (res.data.successful !== 0) {
              this.$notify({
                title: '审核成功',
    ...
    handleHandleReject() {
      this.tableLoading = true
      if (this.params.allSelectTag === 1) {
        handleRejectkOriginInitialPartSubmit(this.params).then(
          res => {
            if (res.data.successful !== 0) {
              this.$notify({
                title: '审核成功',
    ...
    handleReject() {
      ...
      this.$msgbox({
        ...
        message: h('p', null, [
          h('h3', { style: 'color: teal' }, '特别注意：'),
          h('hr', null, ''),
          h('span', null, '取消项目即为此编码项目彻底取消！并且无法恢复并无法创建相同后缀项目，请慎重选择！'),
          h('hr', null, '')
        ]),
        showCancelButton: true,
        confirmButtonText: '确定',
        ...
        beforeClose: (action, instance, done) => {
          if (action === 'confirm') {
            ...
            instance.confirmButtonText = '执行中...'
            if (this.params.allSelectTag === 1) {
              rejectOriginInitialPartSubmit(this.params).then(
                res => {
                  if (res.data.successful !== 0) {
                    this.$notify({
                      title: '取消成功',
