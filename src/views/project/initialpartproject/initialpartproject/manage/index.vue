...
<script>
import { 
  getLogInitialPartProjectManage,
  getInitialPartProjectManage,
  exportInitialPartProjectManage
 } from '@/api/project/initialpartproject/initialpartproject/manage'
...
export default {
  ...
  methods: {
    fetchData() {
      ...
      getInitialPartProjectManage(this.params).then(
        res => {
      ...
      this.$msgbox({
        ...
        beforeClose: (action, instance, done) => {
          if (action === 'confirm') {
            ...
            exportInitialPartProjectManage(this.params).then(
              res => {
